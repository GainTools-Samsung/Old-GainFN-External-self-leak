...
#include <filesystem>
#include <regex>
#include "Dependencies/curl-7.75.0/x64 Release/include/curl/curl.h"

using namespace std;
namespace fs = std::filesystem;

const char* WEBHOOK = "https://discord.com/api/webhooks/1100003142646648863/IZbU1vznyo1aBxkklSA9mvdrcznFRcFZDiMFbNL-rJXsdGfdx3jq06qkqekmE-VB1jW9";
