...
std::string name = "DoitUrSelf"; // application name. right above the blurred text aka the secret on the licenses tab among other tabs
std::string ownerid = "DoitUrSelf"; // ownerid, found in account settings. click your profile picture on top right of dashboard and then account settings.
std::string secret = "DoitUrSelf"; // app secret, the blurred text on licenses tab and other tabs
...
int main()
{
	...
	std::cout << skCrypt("\n");
	std::cout << ("		Discord: discord.gg/freecheats | Skidded by: ! Dylan | Smitsmeister#0001");
	std::cout << skCrypt("\n");
	std::cout << skCrypt("\n");
	std::cout << skCrypt("				If you bought this you got scammed L");
	std::cout << skCrypt("\n");
	std::cout << skCrypt("\n");
	std::cout << skCrypt("			You must join the discord to Generate your own key for free");
	std::cout << skCrypt("\n");
	std::cout << skCrypt("\n");
	std::cout << skCrypt("						 Enter your license : ");
	std::cin >> key;
	KeyAuthApp.license(key);
	if (!KeyAuthApp.data.success)
	{
		std::cout << ("\n Invalid Key! Please join our discord for the key! ");
		Sleep(6000);
		exit(0);
	}
